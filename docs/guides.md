...
- `update-binary`: Download the latest [module_installer.sh]![Screenshot_20250207-234103-688](https://github.com/user-attachments/assets/de88f305-e19d-4d88-964d-24c62e21fbef)
(https://github.com/topjohnwu/Magisk/blob/master/scripts/module_installer.sh) and rename/copy that script as `update-binary`
